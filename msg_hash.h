...
enum msg_hash_enums
{
   ...
   MENU_LABEL(MENU_HDR_BRIGHTNESS_NITS),
   ...
   MENU_LABEL(MENU_XMB_SHOW_HORIZONTAL_LIST),
   ...
   MENU_LABEL(AUDIO_ASIO_CONTROL_PANEL),
   ...
   MENU_LBL_H(SAVESTATE_AUTOMATIC_INTERVAL),
   ...
   MENU_LABEL(RUN_AHEAD_STARTUP_DELAY),
   ...
   MENU_LABEL(ACCESSIBILITY_NARRATOR_ENGINE),
   MENU_LABEL(ACCESSIBILITY_NARRATOR_ENGINE_ESPEAK),
   MENU_LABEL(ACCESSIBILITY_NARRATOR_ENGINE_SPEECH_DISPATCHER),
